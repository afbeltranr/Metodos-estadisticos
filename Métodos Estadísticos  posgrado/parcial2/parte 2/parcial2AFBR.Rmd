...
```{r}
p15 <- pnorm(15, mean = 24, sd = sqrt(14.44))
p15
p15*100
```
Dado que la clase inicia a las 6:00 PM y el estudiante sale de trabajar a las 5:45 PM, el porcentaje de veces que llega tarde a la clase es de $0.89\%$.
...
```{r}
tLentos <- qnorm(0.15, mean = 24, sd = sqrt(14.44))
tLentos
```
El 15% de los viajes más lentos, tienen un tiempo de viaje de por lo menos 20.06 minutos.
