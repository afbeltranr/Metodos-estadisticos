...
msa.m=function(N,n,media,desv,total)  
{ f=n/N
 varmed=(desv^2/n)*(1-f)
 desmed=sqrt(varmed)
 vartotal=N*N*(desv^2/n)*(1-f)
 destotal=sqrt(vartotal)
 a1=media-1.644854*desmed
 b1=media+1.644854*desmed
 a2=total-1.644854*destotal
 b2=total+1.644854*destotal
 cat("media: IC = ",a1, "--",b1,"\n")
 #cat("total: IC = ",a2, "--",b2,"\n")
}

msa.m(200,50,mean(Muestra),sqrt(var(Muestra)),sum(Muestra))

CVE<- (sqrt(var(Muestra)*(1-(50/200))/50))/sum(Muestra)*100
CVE
```
