...
```
Para determinar el error de muestreo, o el coeficiente de variación estimado podemos también crear una función:
...
```
El error de muestreo cuando se determina la masa media al seleccionar una muestra aleatoria simple de 50 marranos a partir de una población de 200 mediante el método de selección - rechazo descrito por [(fan, Muller 1962)](https://www.tandfonline.com/doi/abs/10.1080/01621459.1962.10480667) es del 1.76 $\%$
