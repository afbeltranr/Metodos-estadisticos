...
```
El error de muestreo cuando se determina el total seleccionando una muestra aleatoria simple de 50 marranos a partir de una población de 200 mediante el método de selección - rechazo es del 1.77 $\%$
