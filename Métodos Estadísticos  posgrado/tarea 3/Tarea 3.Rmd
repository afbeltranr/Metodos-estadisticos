...
plot(xh0, yv0, type="h", xlab = "x", ylab = "f(x)", main = "Funcion de masa de Probabilidad Binomial")
...
```
* Tanto la funcion de masa de probabilidad, como la funcion de distribucion acumulada para una variable aleatoria con distribucion Binomial se pueden aproximar a una distribucion normal, las formas son muy similares.
